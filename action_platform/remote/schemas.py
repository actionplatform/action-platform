"""What the hosted API answers with, as pydantic models — the MCP tools' output schemas and the remote client's types. Names match the API's OpenAPI components; a contract test in apps/api keeps them level."""
...
class AppDetail(Open):
    ...
    source_host: dict[str, Any] = Field(default_factory=dict)
