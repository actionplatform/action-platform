...
from action_platform_api.repositories.registry import Entry, MissingManifest
from action_platform_api.schemas import InstallSpec, SourceCredentials
from action_platform_api.services.workspace.manifest import AppManifest
from action_platform_api.services.workspace.checkout import Workspaces
from action_platform.core.flow.repository import Repository
from action_platform.core.scaffold.install import InstallError, install
from action_platform.settings import settings

from action_platform_api.services.apps.base import AppsBase
