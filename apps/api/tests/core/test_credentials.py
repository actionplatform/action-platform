"""app.services.workspace.git_auth — per-request git credentials that never touch the process environment."""
...
try:
    from app.services.workspace.git_auth import SourceCredentials, git_auth
except ImportError:
