...
export const integrations = {
  ...
  hostWebhook: async (id: string) => unwrap(await client.GET("/api/v1/hosts/{host_id}/webhook", { params: { path: { host_id: id } } })),
  rotateHostWebhook: async (id: string) => unwrap(await client.POST("/api/v1/hosts/{host_id}/webhook", { params: { path: { host_id: id } } })),
