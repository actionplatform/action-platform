...
export const v1 = {
  ...
  deleteProject: async (id: string) => unwrap(await client.DELETE("/api/v1/projects/{project_id}", { params: { path: { project_id: id } } })),
  ...
  deleteApp: async (projectId: string, appId: string) =>
    unwrap(await client.DELETE("/api/v1/projects/{project_id}/apps/{app_id}", { params: { path: { project_id: projectId, app_id: appId } } })),
