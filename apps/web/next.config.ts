...
const config: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      { source: "/settings/hosts", destination: "/integrations", permanent: true },
      { source: "/settings/integrations", destination: "/integrations", permanent: true },
      { source: "/integrations/hosts", destination: "/integrations", permanent: true },
      { source: "/integrations/cloud", destination: "/integrations", permanent: true },
