...
| | |
|---|---|
| [Changelog](../CHANGELOG.md) · [web](../apps/web/CHANGELOG.md) · [api](../apps/api/CHANGELOG.md) | what changed in each release of the library and CLI, the web app and the API |
| [`LAST_VERSION`](../LAST_VERSION) · [web](../apps/web/LAST_VERSION) · [api](../apps/api/LAST_VERSION) | the current version of each component — the same files `action-platform release` bumps |
