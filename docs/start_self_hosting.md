...
2. The API applies its migrations on boot (`apps/api/action_platform_api/core/db/migrations/`); nothing to run by hand. Back up the database first for a major jump.
